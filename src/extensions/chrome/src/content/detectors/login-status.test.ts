...
describe("Login Status Detector", () => {
  ...
  describe("isLoginSuccess", () => {
    ...
    it("should detect authenticated UI when password field gone", () => {
      document.body.innerHTML = '<div class="avatar">User</div>';
      // No password field
      expect(isLoginSuccess()).toBe(true);
    });

    it("should detect profile picture", () => {
      document.body.innerHTML = '<img alt="profile picture">';
      expect(isLoginSuccess()).toBe(true);
    });

    it("should detect nav settings link", () => {
      document.body.innerHTML =
        '<nav class="nav"><a href="/settings">Settings</a></nav>';
      expect(isLoginSuccess()).toBe(true);
    });

    it("should not detect success on login page", () => {
      document.body.innerHTML = `
        <form>
    ...
    it("should not detect success without any indicators", () => {
